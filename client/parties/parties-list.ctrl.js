...
angular.module('socially').controller('PartiesListCtrl', [
	...
	function($rootScope, $meteor, $scope, $state) {
		...
		var partiesCount = $meteor.object(Counts, 'numberOfParties', false);
		...
		// "Error: Can't flush inside Tracker.autorun" generated by this code block
		// Start block
/*		$meteor.autorun($scope, function() {
		...
		$scope.showMeMyParty = function(party) {
		...
		$scope.upload = function(partyId) {
			// stub to add file upload function
		};
		...
		$scope.visitParty = function(partyId) {
			$state.go('root.partyDetails', {partyId: partyId});
		};
		...
		$scope.$watch('partiesCount', function() {
			$scope.partiesCount = partiesCount;
		});
